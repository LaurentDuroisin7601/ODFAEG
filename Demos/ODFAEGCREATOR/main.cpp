...
int main(int argc, char* argv[])
{
    ...
    Vec3f p1(24, 600-225, 0);
    Vec3f p2(154, 600-225, 1);
    View view(window.getSize().x, window.getSize().y, 90, 1, 1000);
    window.setView(view);
    std::cout<<window.mapPixelToCoords(Vec3f(p1.x, p1.y, 1))<<std::endl;
    std::cout<<window.mapPixelToCoords(Vec3f(p2.x, p2.y, 0))<<std::endl;
    return 0;*/
