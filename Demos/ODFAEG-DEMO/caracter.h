...
namespace sorrok {
    ...
    public :
        ...
        odfaeg::core::Time getTimeOfLastAttack();
        odfaeg::core::Time getTimeOfLastHpRegen();
        ...
        odfaeg::core::Clock& getClkTransfertTime();
        ...
        odfaeg::core::Clock clockAtkSpeed, clockRegenHp, clockTransfertTime;
