...
module odfaeg.entity.transformable;
...
namespace odfaeg {
	namespace entity {
        ...
        */
        math::TransformMatrix& Transformable::getTransform() {
            return tm;
        }
        /**
        ...
        */
        math::TransformMatrix Transformable::getInverseTransform() {
            math::TransformMatrix invers = tm;
       ...
       */
        void Transformable::combine(math::TransformMatrix& tm) {
            this->tm.combine(tm.getMatrix());
        }
        void Transformable::setTransform(math::TransformMatrix& tm) {
