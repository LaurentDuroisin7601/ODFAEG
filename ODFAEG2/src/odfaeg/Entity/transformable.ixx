module;
export module odfaeg.entity.transformable;
...
namespace odfaeg {
    namespace entity {
        ...
        public:            
            ...
            */
            math::TransformMatrix& getTransform();
            /**
            ...
            */
            math::TransformMatrix getInverseTransform();
            /**
           ...
           */
            void combine(math::TransformMatrix& tm);
            void setTransform(math::TransformMatrix& tm);
