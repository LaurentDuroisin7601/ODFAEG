...
namespace odfaeg {
    namespace window {
        ...
        ////////////////////////////////////////////////////////////
        void WindowImpl::create(VideoMode mode, const core::String& title, std::uint32_t style)
        {
            ...
            WindowImplType::create(mode, title, style);
            initialize();
        }
        ////////////////////////////////////////////////////////////
        void WindowImpl::create(WindowHandle handle)
        {
            // Recreate the WindowImpl implementation
            WindowImplType::destroy();
            WindowImplType::create(handle);
            initialize();
        }
        ////////////////////////////////////////////////////////////
        ...
        {
			WindowImplType::setMouseCursor(cursor.getImpl().getImplType());
        }
        ////////////////////////////////////////////////////////////
        ...
        WindowImplType& WindowImpl::getImplType() {
            return *this;
        }
