...
namespace odfaeg {
    namespace window {
        ...
        ////////////////////////////////////////////////////////////
        Win32Window::Win32Window(VideoMode mode, const core::String& title, std::uint32_t style) :
            m_handle(NULL),
            m_callback(0),
            m_cursorVisible(true), // might need to call GetCursorInfo
            m_lastCursor(LoadCursor(NULL, IDC_ARROW)),
        ...
        void Win32Window::create(VideoMode mode, const core::String& title, std::uint32_t style) {
            ...
            setSize(math::Vector2u(mode.width, mode.height));
        ...
        {
            return (odfaeg::window::HWND__*)m_handle;
        }
        ...
        ////////////////////////////////////////////////////////////
        math::Vector2i Win32Window::getPosition() const
        {
            RECT rect;
        ...
        ////////////////////////////////////////////////////////////
        void Win32Window::setPosition(const math::Vector2i& position)
        {
        ...
        ////////////////////////////////////////////////////////////
        math::Vector2u Win32Window::getSize() const {
            RECT rect;
        ...
        ////////////////////////////////////////////////////////////
        void Win32Window::setSize(const math::Vector2u& size)
        {
        ...
        ////////////////////////////////////////////////////////////
        void Win32Window::setTitle(const core::String& title)
        {
        ...
        ////////////////////////////////////////////////////////////
        void Win32Window::setMouseCursor(const Win32Cursor& cursor)
        {
        ...
        bool Win32Window::popEvent(IEvent& event, bool block) {
                ...
                if (m_keyRepeatEnabled || ((lParam & (1 << 30)) == 0))
                {
                    ...
                    else
                    {
                        ...
                        if ((character >= 0xDC00) && (character <= 0xDFFF))
                        {
                            ...
                            core::Utf16::toUtf32(utf16, utf16 + 2, &character);
                            m_surrogate = 0;
                        }
