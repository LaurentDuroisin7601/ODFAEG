...
namespace odfaeg {
    namespace window {
        ...
        ////////////////////////////////////////////////////////////
        math::Vector2i X11Mouse::getPosition()
        {
            // Open a connection with the X server
            ::Display* display = Display::openDisplay();
            // we don't care about these but they are required
            ...
            Display::closeDisplay(display);
            return math::Vector2i(gx, gy);
        }


        ////////////////////////////////////////////////////////////
        math::Vector2i X11Mouse::getPosition(const X11Window& relativeTo)
        {
