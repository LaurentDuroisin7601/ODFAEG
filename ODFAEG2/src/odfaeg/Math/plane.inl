 namespace odfaeg {
    namespace math {        
        Plane::Plane() {}
        Plane::Plane(Vec3f n, Vec3f p) : n(n), p(p) {
            a = n.x();
            b = n.y();
            c = n.z();
            d = -n.dot(p);
        }
        float Plane::whichSide(Vec3f other) {
            return a * other.x() + b * other.y() + c * other.z() + d;
        }
        bool Plane::intersects(Ray& r, Vec3f& intersection) {
        ...
        bool Plane::intersects(Ray& r, float& i) {
