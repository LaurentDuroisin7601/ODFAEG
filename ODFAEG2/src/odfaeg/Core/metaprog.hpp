	...
	namespace core {
            ...
            struct unique_impl<Acc, std::tuple<T, Rest...>> {
                using type = std::conditional_t <
                    ...
                    // d�j� pr�sent : on ne l'ajoute pas
                    typename unique_impl<Acc, std::tuple<Rest...>>::type,
                    // pas pr�sent : on l'ajoute � Acc
            ...
            // Sp�cialisation vide (optionnelle, mais coh�rente avec ton code)
            template <>
        ...
        //Utilitaire pour ajouter un type � la fin d'un tuple
        ...
        //La visite se fait sur le type acceptable qui contient l'information sur le type r�el
        template<class, class...>
        struct visitor;
        ...
        //Utilitaire pour r�cup�rer le type accept� par la hi�rarchie depuis le visiteur
        template<class, class>
        struct accept_type;
        ...
        //Utilitaire pour r�cup�rer les types concrets de la hi�rarchie depuis le visiteur
        template<class>
        ...
        //Classe de base qui ajoute accept � la classe de base de la hi�rarchie
        template<class Abstract, class... Concrete>
        ...
        //Condition d'arr�t sur les types de la hi�rarchie
        template<
        ...
        //R�cursion sur les types de la hi�rarchie
        template<
        ...
        public:
            ...
            //D�clenche la visite sur le bon param�tre
            void operator()() const
            {
                std::get
            ...
            void visit(typename accept_type<Visitor, T>::type&) const
            {
                ...
                //R�cursion sur les arguments d'appel
                dispatcher<
        ...
        //Condition d'arr�t sur les param�tre d'appel
        template<
            class To_Visit, class... Visited,
        ...
        >
        {
            ...
            //D�clenche l'appel avec les bon types
            void operator()()
            {
        ...
        //Classe de base pour les foncteurs � dispatcher
