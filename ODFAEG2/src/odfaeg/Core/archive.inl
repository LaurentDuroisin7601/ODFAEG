namespace odfaeg {
    namespace core {        
        ...
        */
        template <typename T>
        void OTextArchive::operator() (std::reference_wrapper<T> ref) requires IsFundamental<T> {
            T& data = ref.get();
        ...
        */
        template <typename E>
        void OTextArchive::operator() (E& data) requires IsEnum<E> {
            buffer << data << std::endl;
        ...
        */
        template <typename E>
        void OTextArchive::operator() (std::reference_wrapper<E> ref) requires IsEnum<E>{
            E& data = ref.get();
            std::ostringstream oss;
            oss << typeid(data).name() << "*" << reinterpret_cast<unsigned long long int>(&data);
            std::map<std::string, long long int>::iterator it = adresses.find(oss.str());
        ...
        */
        template <typename T>
        void OTextArchive::operator() (T & data) requires IsString<T> {
        ...
        */
        template <typename T>
        void OTextArchive::operator() (std::reference_wrapper<T> ref) requires IsString<T> {
            T& data = ref.get();
            std::ostringstream oss;
            oss << typeid(data).name() << "*" << reinterpret_cast<unsigned long long int>(&data);
            std::map<std::string, long long int>::iterator it = adresses.find(oss.str());
        ...
        */
        template <class O>
        void OTextArchive::operator() (std::vector<O>& data) {
        ...
        */
        template <class T>
        void OTextArchive::operator() (std::unique_ptr<T>& ptr) {
            (*this)(ptr.get());
        }
        /**
        ...
        */
        ...
        void OTextArchive::operator() (std::pair<T1, T2>& pair) {
            (*this)(pair.first);
            (*this)(pair.second);
        }
        /**
        ...
        */
        template <class T1, class T2>
        void OTextArchive::operator() (std::map<T1, T2>& map) {
        ...
        */
        template <typename T>
        void ITextArchive::operator() (T& data) requires IsFundamental<T> {
        ...
        */
        template <typename T>
        void ITextArchive::operator() (std::reference_wrapper<T> ref) requires IsFundamental<T> {
            T& data = ref.get();
            long long int id;
            buffer >> id;
        ...
        */
        template <typename E>
        void ITextArchive::operator()(E& data) requires IsEnum<E> {
            int eVal;
            buffer >> eVal;
        ...
        */
        template <typename E>
        void ITextArchive::operator()(std::reference_wrapper<E> ref) requires IsEnum<E> {
            E& data = ref.get();
            long long int id;
            buffer >> id;
        ...
        */
        template <typename T>
        void ITextArchive::operator() (T& data) requires IsString<T> {
            /*long long int id;
            buffer>>id;
            char space;
            buffer.get(space);
         ...
         */
        template <typename T>
        void ITextArchive::operator() (std::reference_wrapper<T> ref) requires IsString<T> {
            T& data = ref.get();
            long long int id;
            buffer >> id;
            char space;
        ...
        */
        template <class O>
        void ITextArchive::operator() (std::vector<O>& objects) {
            std::size_t size;
            buffer >> size;
            char space;
            buffer.get(space);
        ...
        */
        template <class T>
        void ITextArchive::operator() (std::unique_ptr<T>& ptr) {
            T* tmp;
            (*this)(tmp);
            if (tmp != nullptr)
                ptr.reset(tmp);
        ...
        */
        template <class T1, class T2>
        void ITextArchive::operator()(std::pair<T1, T2>& pair) {
            T1 type1;
            T2 type2;
            (*this)(type1);
            (*this)(type2);
        ...
        */
        template <class T1, class T2>
        void ITextArchive::operator()(std::map<T1, T2>& map) {
            std::size_t size;
            buffer >> size;
            char space;
            buffer.get(space);
