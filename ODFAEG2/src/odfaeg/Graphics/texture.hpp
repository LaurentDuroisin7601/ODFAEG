...
namespace odfaeg {
	namespace graphic {
		...
		public :
            ...
            bool createDepthTexture(uint32_t texWidth, uint32_t texHeight, VkSampleCountFlagBits msaaSamples, uint32_t depth=1, uint32_t layersPerView=1, bool layered=false);
