namespace odfaeg {
    namespace graphic {
          ...
          useThread(useThread)
        {
            ...
            envMap.createCubeMap(ENV_MAP_SIZE);
        ...
        void EnvMapRenderer::createCommandPools() {
            ...
            for (unsigned int i = 0; i < reflRefrGameObjects.size(); i++) {
                ...
                reflRefrCmdPools[i].createCommandBuffers(false, MAX_FRAMES_IN_FLIGHT);
            }
        }
