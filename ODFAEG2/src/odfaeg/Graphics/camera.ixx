...
namespace odfaeg {
    namespace graphic {
        ...
        public:
            ...
            */
            Camera(double width, double height, double zNear, double zFar);
            /**
            ...
            * \param up : the up vector of the view.
            */
            Camera(double width, double height, double fovy, double zNear, double zFar);
            /**
            ...
            * \param z : the z.
            */
            void lookAt(float x, float y, float z, math::Vec3f up = math::Vec3f(0.f, 1.f, 0.f));
            ...
            */
            void setViewport(physic::BoundingBox rect);            
            /**
        ...
        private:
            ...
            */
            ...
            math::Vec3f center, up, target, forward, left; /**> The position, the up vector, the target, the forward and the left vector of the view.*/
            float teta, gamma, phi; /**> The angles and the zoom factor of the view.*/
