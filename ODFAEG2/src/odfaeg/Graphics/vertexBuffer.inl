        ...
        void VertexBuffer::update(VkCommandBuffer& commandBuffer, unsigned int currentFrame) {
            ...
            if (needToUpdateVertexBuffer[currentFrame]) {
                ...
                if (bufferSize > maxVerticesSize[currentFrame]) {
                    ...
                    vertexBuffer[currentFrame].create(bufferSize, VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_STORAGE_BUFFER_BIT | VK_BUFFER_USAGE_VERTEX_BUFFER_BIT | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT, VMA_MEMORY_USAGE_GPU_ONLY, true);
            ...
            if (needToUpdateIndexBuffer[currentFrame]) {
                ...
                if (bufferSize > maxIndexSize[currentFrame]) {
                    ...
                    indexBuffer[currentFrame].create(bufferSize, VK_BUFFER_USAGE_TRANSFER_DST_BIT | VK_BUFFER_USAGE_STORAGE_BUFFER_BIT | VK_BUFFER_USAGE_INDEX_BUFFER_BIT | VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT, VMA_MEMORY_USAGE_GPU_ONLY, true);
