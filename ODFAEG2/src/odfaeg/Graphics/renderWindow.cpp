...
#include <odfaeg/Graphics/windowHandle.hpp>
#include <iostream>
...
namespace odfaeg {
	namespace graphic {
        ...
        ////////////////////////////////////////////////////////////
        RenderWindow::RenderWindow(WindowHandle handle, Device& device, bool useDepth, bool useStencil) : RenderTarget(device, useDepth, useStencil), device(device), swapchain(device)
        {
            // Don't call the base class constructor because it contains virtual function calls
            create(handle);
        }
