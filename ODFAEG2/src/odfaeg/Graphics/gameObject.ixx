...
#include <deque>
#include <glm/glm.hpp>
export module odfaeg.graphic.gameObject;
...
namespace odfaeg {
	namespace graphic {
        export class SubMesh : public core::NonCopyable {
            public:
            /**
            * \fn Face()
            * \brief constructor.
        ...
        private:
        	bool instanced;
            VertexBuffer m_vertices; /**> the vertices.*/
            std::unique_ptr<Material> m_material; /**> the material.*/
        };		
		export class GameObject : public entity::Entity, public Transformable {
		public:
			struct BoneInfo {
			...
			void copyFrom(GameObject& gameObject);
