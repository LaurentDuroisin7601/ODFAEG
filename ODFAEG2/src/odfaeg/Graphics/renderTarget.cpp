...
namespace odfaeg {
	namespace graphic {
		...
		void RenderTarget::initialize() {
			...
			m_defaultCamera = Camera(static_cast<float>(getSize().x()), static_cast<float>(getSize().y()), -static_cast<float>(getSize().y()) - 200, static_cast<float>(getSize().y()) + 200);
			m_defaultCamera.setViewport(physic::BoundingBox(0, 0, -static_cast<float>(getSize().y()) - 200, static_cast<float>(getSize().x()), static_cast<float>(getSize().y()), static_cast<float>(getSize().y()) + 200));
