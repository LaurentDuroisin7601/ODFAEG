module;
#include <algorithm>
export module odfaeg.graphic.rect;
...
export namespace odfaeg {
    namespace graphic {
        ...
        ////////////////////////////////////////////////////////////
        template <typename T>
        Rect<T>::Rect(const math::VecN<T, 2>& position, const math::VecN<T, 2>& size) :
            left(position.x),
            top(position.y),
            width(size.x),
            height(size.y)
        ...
        ////////////////////////////////////////////////////////////
        template <typename T>
        bool Rect<T>::contains(const math::VecN<T, 2>& point) const
        {
