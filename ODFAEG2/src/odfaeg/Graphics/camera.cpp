...
namespace odfaeg {
    namespace graphic {
        ...
        Camera::Camera(double width, double height, double zNear, double zFar) : viewport(0, 0, zNear, width, height, zFar) {
        ...
        Camera::Camera(double width, double height, double fovy, double zNear, double zFar) : viewport(0, 0, zNear, width, height, zFar) {
        ...
        physic::BoundingBox Camera::getViewVolume() {
            physic::BoundingBox viewVolume(-getViewport().getSize().x() * 0.5f,
                -getViewport().getSize().y() * 0.5f,
                -getViewport().getSize().z() * 0.5f,
                getViewport().getSize().x(),
                getViewport().getSize().y(),
                getViewport().getSize().z());
