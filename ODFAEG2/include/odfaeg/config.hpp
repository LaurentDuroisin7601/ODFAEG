...
#define ODFAEG_VERSION_PATCH 0
#define ODFAEG_MATH_EXPORTS
#define ODFAEG_CORE_EXPORTS
#define ODFAEG_WINDOW_EXPORTS
#define ODFAEG_ENTITY_EXPORTS
#define ODFAEG_PHYSICS_EXPORTS
#define ODFAEG_GRAPHICS_EXPORTS
#define ODFAEG_AUDIO_EXPORTS
#define ODFAEG_NETWORK_EXPORTS
#include <mutex>
static std::recursive_mutex& getGlobalMutex() {
    static std::recursive_mutex rec_mutex;
    return rec_mutex;
}
static const unsigned int MAX_TEXTURES = 1024;
static const unsigned int MAX_BONES = 100;
static const unsigned int MAX_BONES_INFLUENCE = 4;
static const unsigned int NB_PRIMITIVE_TYPES = 6;
