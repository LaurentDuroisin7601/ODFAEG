...
layout (std140, set = 0, binding = 1) uniform LightMatricesUBO {
    mat4 lightSpaceMats[NB_CASCADES+1];   
...
void main() {
    ...
    gl_Position = lightMatsData[pc.currentFrame].lightSpaceMats[gl_ViewIndex] * modelMatrix * vec4(inPosition, 1);
    /*if (gl_ViewIndex == 1)
