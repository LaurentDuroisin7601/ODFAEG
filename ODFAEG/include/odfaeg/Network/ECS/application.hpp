    ...
    namespace core {
        namespace ecs {
            ...
            public :
                ...
                */
                Application(window::VkSettup& vkSettup, graphic::ecs::ComponentMapping& componentMapping, sf::VideoMode vm, std::string title, sf::Uint32 style = sf::Style::Default, window::ContextSettings settings = window::ContextSettings()) : world(componentMapping)
