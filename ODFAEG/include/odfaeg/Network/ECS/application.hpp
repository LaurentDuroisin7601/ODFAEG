        ...
        namespace ecs {
            ...
            */
            ...
            public :
                ...
                *   \param ContextSettings : advanced opengl settings.
                */
                Application(window::VideoMode vm, graphic::ecs::ComponentMapping& componentMapping, std::string title, std::uint32_t style = window::Style::Default, window::ContextSettings settings = window::ContextSettings()) : world(componentMapping)
