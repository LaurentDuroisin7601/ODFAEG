...
namespace odfaeg {
    namespace physic {
        ...
        class ODFAEG_PHYSICS_API BoundingEllipsoid : public BoundingVolume {
            public :
                BoundingEllipsoid() : radius(1, 1, 1), center(0, 0, 0) {}
                /**
                ...
                **/
                ...
                const BoundingEllipsoid& operator= (const BoundingEllipsoid& other) {
                    ...
                    this->tmTranslation = other.tmTranslation;
                    this->tmRotation = other.tmRotation;
                    this->tmScale = other.tmScale;
                    return *this;
                }
            ...
            private :
                ...
                graphic::TransformMatrix tmScale, tmTranslation, tmRotation;
        };
    }
}
#endif
