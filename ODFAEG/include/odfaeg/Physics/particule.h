...
namespace odfaeg
{
    namespace physic {
        ...
        // Public variables
        public:
        math::Vec3f	position;	///< Current position.
        math::Vec3f	velocity;	///< Velocity (change in position per second).
        float	rotation;	///< Current rotation angle.
        float	rotationSpeed;	///< Angular velocity (change in rotation per second).
        math::Vec3f	scale;	///< Scale, where (1,1) represents the original size.
