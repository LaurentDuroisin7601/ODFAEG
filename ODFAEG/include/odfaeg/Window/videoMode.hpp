#ifndef ODFAEG_VIDEO_MODE_HPP
#define ODFAEG_VIDEO_MODE_HPP
#include "export.hpp"
#include <vector>
namespace odfaeg {
    namespace window {
        class ODFAEG_WINDOW_API VideoMode
        {
        public:
        ...
        ///
        ////////////////////////////////////////////////////////////
        ODFAEG_WINDOW_API bool operator ==(const VideoMode& left, const VideoMode& right);
