...
namespace odfaeg {
    namespace window {
        ...
        ///
        ////////////////////////////////////////////////////////////
        class ODFAEG_WINDOW_API WglContext : public IContext
        {
        public:
            WglContext();
            ////////////////////////////////////////////////////////////
            ...
            virtual void create(WindowHandle window, const ContextSettings& settings, IContext* shared = nullptr, unsigned int bitsPerPixel=32);
