...
namespace odfaeg {
    namespace window {
        class ODFAEG_WINDOW_API X11Window : public IWindow {
        public :
            X11Window();
            X11Window(sf::VideoMode mode, const core::String& title, sf::Uint32 style, const ContextSettings& settings);
            ...
            virtual void create (sf::VideoMode mode, const core::String& title, sf::Uint32 style, const ContextSettings& settings);
