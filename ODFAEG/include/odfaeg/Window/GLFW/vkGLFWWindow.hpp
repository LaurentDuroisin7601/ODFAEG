...
namespace odfaeg {
    namespace window {
        class ODFAEG_WINDOW_API VKGLFWWindow : public IWindow {
            public :
            VKGLFWWindow ();
            VKGLFWWindow (sf::VideoMode mode, const core::String& title, sf::Uint32 style, const ContextSettings& settings);
