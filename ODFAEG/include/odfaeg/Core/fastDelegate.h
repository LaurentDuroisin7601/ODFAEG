    ...
    namespace core {
        ...
        */
        ...
        private:
            ...
            * We also remove const qualifier's and we pass the placeholders's types to the LateParameters class.
            */
            using late_params_t
              = jln::mp::copy_if<jln::mp::lift<is_placeholder>,
                            jln::mp::unique<jln::mp::sort<LessPlaceceholder,
                                                jln::mp::lift<LateParameters>>>>
                ::f<std::remove_cv_t<ArgT>...>; /**> alias to the placeholders's holder.*/
