    ...
    namespace core {
        ...
        */
        class RuntimeCompiler {
            ...
            */
            ODFAEG_CORE_API RuntimeCompiler(std::string funcName);
            /**
            * \fn void compile()
            * \brief compile code of the c++ files.
            */
            ODFAEG_CORE_API void compile();
            ODFAEG_CORE_API void makeExec();
            ODFAEG_CORE_API void exec();
            ODFAEG_CORE_API std::string getErrors();
            /**
