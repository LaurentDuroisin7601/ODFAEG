...
namespace odfaeg {
    namespace core {
        ...
        *  \return the int.
        */
        ODFAEG_CORE_API sf::Int32 conversionStringInt(std::string str);
        /**\fn Int64 conversionStringLong(std::string str);
        *  \brief convert an std::string into an Int64.
        *  \param the std::string to convert.
        *  \return the int.
        */
        ODFAEG_CORE_API sf::Int64 conversionStringLong(std::string str);
        ODFAEG_CORE_API sf::Uint64 conversionStringULong(std::string str);
        ...
        *  \return the std::string.
        */
        ODFAEG_CORE_API std::string conversionIntString(sf::Int32 i);
        ...
        */
        ...
        ODFAEG_CORE_API std::string conversionLongString(sf::Int64 i);
