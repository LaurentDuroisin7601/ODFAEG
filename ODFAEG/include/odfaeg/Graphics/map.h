...
class ODFAEG_GRAPHICS_API Scene : public SceneManager {
    ...
    public :
        ...
        */
        void rotateEntity(Entity *entity, float angle, math::Vec3f axis);
        /**
        ...
        */
        void scaleEntity(Entity *entity, float sx, float sy, float sz);
        /**
        ...
        */
        ...
        void generate_labyrinthe(std::vector<Tile*> tGround, std::vector<g2d::Wall*> walls, math::Vec2f tileSize, physic::BoundingBox &box, EntityFactory& factory);
        void generate_3d_labyrinthe(std::vector<Tile*> tGround, std::vector<g3d::Wall*> walls, math::Vec2f tileSize, physic::BoundingBox &box, EntityFactory& factory);
        ...
        */
        void generate_map(std::vector<Tile*> tGround, std::vector<g2d::Wall*> walls, math::Vec2f tileSize, physic::BoundingBox &box, EntityFactory& factory);
        void generate_3d_map(std::vector<Tile*> tGround, std::vector<g3d::Wall*> walls, math::Vec2f tileSize, physic::BoundingBox &box, EntityFactory& factory);
        /**
        ...
        */
        ...
        int getCellHeight();
        int getCellDepth();
        math::Vec3f physicallyBasedComputePos (Entity* entity, math::Vec3f oldCenter, math::Vec3f size, math::Vec3f velocity, float climpCapacity);
    private :
        void addAnimationChildren(Entity* entity, std::vector<Entity*>& entities, std::string type);
