...
namespace odfaeg {
    namespace core {
        ...
        */
        ...
        class  Application {
            public :
             Application(sf::VideoMode vm, std::string title, sf::Uint32 style=sf::Style::Default, window::ContextSettings settings = window::ContextSettings()) : vkDevice(vkSettup)
            ...
            */
            ...
            odfaeg::core::ResourceCache<T>& getResourceCache() {
        ...
        private :
            ...
            odfaeg::core::ResourceCache<T> resourceCache;
