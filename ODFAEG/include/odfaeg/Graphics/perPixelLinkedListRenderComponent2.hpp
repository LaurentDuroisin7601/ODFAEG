...
namespace odfaeg {
    namespace graphic {
        #ifdef VULKAN
        class ODFAEG_GRAPHICS_API PerPixelLinkedListRenderComponent2 : public HeavyComponent {
            public :
            ...
            PerPixelLinkedListRenderComponent2 (RenderWindow& window, int layer, std::string expression, window::ContextSettings settings, bool useThread = true);
            ...
            */
            ...
            virtual ~PerPixelLinkedListRenderComponent2();
            private :
            void executeThreadPools();
            ...
            void recordCommandBufferIndirect(unsigned int currentFrame, unsigned int p, unsigned int nbIndirectCommands, unsigned int stride, PPLLDepthStencilID depthStencilID, unsigned int vertexOffset, unsigned int indexOffset, unsigned int uboOffset, unsigned int modelDataOffset, unsigned int materialDataOffset, unsigned int drawCommandOffset, RenderStates currentStates, VkCommandBuffer commandBuffer);
            ...
            void recordCommandBufferVertexBuffer(unsigned int currentFrame, RenderStates currentStates, VkCommandBuffer commandBuffer);
            ...
            std::array<unsigned int, MAX_FRAMES_IN_FLIGHT> values, values2={0, 0};
            ...
            std::array<std::atomic<bool>, MAX_FRAMES_IN_FLIGHT> offscreenCommandBufferReady = {true, true};
            ...
            bool executeThreadPoolRunning = false;
            ...
            std::vector<VkFence> threadPoolFences;
            unsigned int windowCurrentFrame=0, windowCurrentImage = 0, threadpoolCurrentFrame=0;
            std::thread executePools;
        };
        #else
