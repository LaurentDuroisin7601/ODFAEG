...
namespace odfaeg {
    namespace graphic {
        ...
        class ODFAEG_GRAPHICS_API EntityLight : public Light, public GameObject {
            public :
            /**
            * \fn EntityLight (math::Vec3f center, Color color, float radius1, float radius2, float radius3, int height, std::string type, Entity* parent)
            * \brief constructor.
            ...
            */
            EntityLight (math::Vec3f center, Color color, float radius1, float radius2, float radius3, int height, std::string type, EntityFactory& factory, std::string name = "",Entity* parent=nullptr)
            : Light (center, radius1, height, color), GameObject (center, math::Vec3f(radius1 * 2, radius2 * 2, radius3 * 2), math::Vec3f (radius1, radius2, radius3), type, factory, name, parent) {
            }
            Color getColor() {
                return color;
            }
