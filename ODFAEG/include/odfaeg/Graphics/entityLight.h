    ...
    namespace graphic {
        ...
        class ODFAEG_GRAPHICS_API EntityLight : public Light, public GameObject {
            ...
            */
            ...
            : Light (center, radius1, height, color), GameObject (math::Vec3f(center.x, center.y, center.z), math::Vec3f(radius1 * 2, radius2 * 2, radius3 * 2), math::Vec3f (radius1, radius2, radius3), type, factory, name, parent) {
            }
            sf::Color getColor() {
                return color;
            }
