    ...
    namespace graphic {
        ...
        public :
            ...
            */
            ...
            virtual bool collide (Entity* entity, math::Vec3f position, physic::CollisionResultSet& cinfos) = 0;
            virtual bool collide (Entity* entity, math::Ray ray,  physic::CollisionResultSet& cinfos) = 0;
            /**
            ...
            */
            virtual void generate_map(std::vector<Tile*> tGrounds, std::vector<g2d::Wall*> tWalls, math::Vec2f tileSize, physic::BoundingBox& zone, EntityFactory& factory) = 0;
            virtual void generate_3d_map(std::vector<Tile*> tGrounds, std::vector<g3d::Wall*> tWalls, math::Vec2f tileSize, physic::BoundingBox& zone, EntityFactory& factory) = 0;
            virtual void generate_labyrinthe(std::vector<Tile*> tGrounds, std::vector<g2d::Wall*> tWalls, math::Vec2f tileSize, physic::BoundingBox& zone, EntityFactory& factory) = 0;
            virtual void generate_3d_labyrinthe(std::vector<Tile*> tGrounds, std::vector<g3d::Wall*> tWalls, math::Vec2f tileSize, physic::BoundingBox& zone, EntityFactory& factory) = 0;
            /**
            ...
            */
            ...
            virtual void scaleEntity(Entity* entity, float sx, float sy, float sz) = 0;
            virtual void rotateEntity(Entity* entity, float angle, math::Vec3f axis) = 0;
            /**
            ...
            */
            ...
            virtual math::Vec3f physicallyBasedComputePos (Entity* entity, math::Vec3f oldCenter, math::Vec3f size, math::Vec3f velocity, float climpCapacity) = 0;
        };
    }
}
