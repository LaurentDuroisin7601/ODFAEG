    ...
    namespace graphic {
        ...
        class ODFAEG_GRAPHICS_API Material {
             ...
             */
             struct ODFAEG_GRAPHICS_API TextureInfo {
                ...
                */
                bool operator== (TextureInfo& info) const;
                /**
                * \fn bool operator!= (TextureInfo& info)
                * \param the other texture info.
                * \brief compare a texture info with another one.
            ...
            */
            ...
            void setLightInfos (math::Vec3f lightCenter, sf::Color lightColor);
        ...
        class ODFAEG_GRAPHICS_API Instance {
            ...
            */
            ...
            std::vector<std::vector<math::Matrix4f>>& getFinalBoneMatrices();
        ...
        private:
            ...
            std::vector<std::vector<math::Matrix4f>> m_finalBoneMatrices;
