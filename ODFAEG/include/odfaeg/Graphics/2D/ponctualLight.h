        ...
        namespace g2d {
            ...
            */
            ...
            public :
                ...
                * \brief constructor.
                */
                PonctualLight(EntityFactory& factory) : EntityLight(math::Vec3f(0, 0, 0),Color(0, 0, 0, 0),0, 0, 0, 0,"E_PONCTUAL_LIGHT", factory, "",nullptr) {
                }
                /**
                * \fn PonctualLight(math::Vec3f center, float radius1, float radius2, float radius3, float intensity, Color color, int quality, Entity *parent = nullptr);
                * \brief constructor.
                ...
                */
                PonctualLight(math::Vec3f center, float radius1, float radius2, float radius3, float intensity, Color color, int quality, EntityFactory& factory, Entity *parent = nullptr);
                /**
