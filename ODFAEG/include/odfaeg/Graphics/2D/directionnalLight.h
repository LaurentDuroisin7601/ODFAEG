    ...
    namespace graphic {
        namespace g2d {
            ...
            public :
                ...
                DirectionnalLight (math::Vec3f center, math::Vec3f dir, int height, float r1, float r2, float r3, float intensity, Color color, int quality, EntityFactory& entity, Entity* parent = nullptr);
                int getLightId() {
                    return Entity::getId();
                }
                void initTriangles ();
