...
namespace odfaeg {
    namespace graphic {
        namespace g2d {
            ...
            private :
                  /**  \fn AmbientLight(math::Vec3f center, int height, Color color)
                  ...
                  *    \param Color color : the color of the ambient light.
                  */
                  AmbientLight (math::Vec3f center, math::Vec3f dir, float radius, int height, Color color) :
                      Light (center, radius, height, color), dir(dir) {
            ...
            public :
                  math::Vec3f getLightDir() {
                      return dir;
                  }
                  /**
                  *  \fn void setAmbientLight(math::Vec3f center, int height, Color)
                  *  \brief set the AmbientLight of the scene.
                  *  \param math::Vec3f center : the center of the ambient light.
                  *  \param int height : the height of the ambient light.
                  *  \param Color color : the color of the ambient light.
                  */
                  static void setAmbientLight(math::Vec3f center, math::Vec3f dir, float radius, int height, Color color);
                  /**
