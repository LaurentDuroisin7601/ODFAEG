    ...
    namespace graphic {
        namespace g2d {
            ...
            private :
                  ...
                  */
                  AmbientLight (math::Vec3f center, float radius, int height, sf::Color color) :
            ...
            public :
                  ...
                  *  \param sf::Color color : the color of the ambient light.
                  */
                  static void setAmbientLight(math::Vec3f center, float radius, int height, sf::Color color);
                  /**
