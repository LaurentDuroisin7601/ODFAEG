    ...
    namespace graphic {
        namespace g2d {
            ...
            private :
                  ...
                  */
                  AmbientLight (math::Vec3f center, float radius, int height, Color color) :
                      Light (center, radius, height, color) {
            ...
            public :
                  ...
                  *  \param Color color : the color of the ambient light.
                  */
                  static void setAmbientLight(math::Vec3f center, float radius, int height, Color color);
                  /**
