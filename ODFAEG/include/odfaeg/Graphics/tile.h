    ...
    namespace graphic {
        ...
        class ODFAEG_GRAPHICS_API Tile : public GameObject/*, public Selectable*/ {
            public :
                ...
                */
                Tile (const Texture *image, math::Vec3f position, math::Vec3f size, IntRect subRect, EntityFactory& factory,  Color color = Color::White, Entity* parent = nullptr);
                Entity* clone();
