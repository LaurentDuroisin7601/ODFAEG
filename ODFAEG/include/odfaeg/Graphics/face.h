...
class ODFAEG_GRAPHICS_API Material {
     ...
     */
     struct TextureInfo {
        ...
        IntRect rect; /**> The coordinates of the texture.*/
        ...
        * \brief constructor
        */
        TextureInfo (const Texture* texture, IntRect rect, std::string texId="") {
    ...
    */
    void addTexture (const Texture* texture, IntRect rect) {
        texInfos.push_back(new TextureInfo(texture, rect));
    }
    /**
    * \fn IntRect getTexRect(int texUnit = 0) const {
    ...
    */
    IntRect getTexRect(int texUnit = 0) const {
