...
namespace odfaeg {
    namespace graphic {
        namespace ecs {
            ...
            class ODFAEG_GRAPHICS_API Grid {
                public :
                    /**
                    ...
                    */
                    Grid (ComponentMapping& componentMapping, int cellWidth=100, int cellHeight=50, int cellDepth=0);
                    /** \fn  ~GridMap ();
                    *   \brief destructor.
                    */
                    ~Grid ();
                    ...
                    * \return the entity.
                    */
                    EntityId getEntity (entt::entity);
