...
namespace odfaeg {
    namespace graphic {
        namespace ecs {
            ...
            struct MainSystem {
                template <size_t I, typename... Components, typename T1, typename T2, class = typename std::enable_if_t<std::tuple_size_v<T1> != 0 && I < std::tuple_size_v<T1>-1>>
                ...
                template <size_t I, typename... Components, typename T1, typename T2, class... D, class = typename std::enable_if_t<std::tuple_size_v<T1> != 0 && I == std::tuple_size_v<T1>-1>>
                void operator()(EntityId entity, ComponentMapping& componentMapping, std::vector<EntityId> entities, T1& systems, T2& params) {
                    if (componentMapping.getComponent<std::tuple_element_t<I, T1>>(entity) != nullptr) {
                ...
                template <size_t I, typename... Components, typename T1, typename T2, class... D, class... E, class = typename std::enable_if_t<std::tuple_size_v<T1> == 0>>
                void operator()(EntityId entity, ComponentMapping& componentMapping, std::vector<EntityId> entities, T1& systems, T2& params) {
                }
