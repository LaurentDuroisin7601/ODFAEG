...
namespace odfaeg {
    namespace graphic {
        namespace ecs {
            class ODFAEG_GRAPHICS_API Component : public Drawable, public Transformable {
            public :
                ...
                */
                ...
                virtual bool loadEntitiesOnComponent(ComponentMapping& componentMapping, std::vector<EntityId> entities);
