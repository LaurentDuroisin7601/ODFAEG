            ...
            class ODFAEG_GRAPHICS_API Scene : public SceneManager {
                ...
                public :
                    ...
                    */
                    ...
                    Scene(ComponentMapping& componentMapping);
                    Scene(RenderComponentManager* frcm, ComponentMapping& componentMapping, std::string name, int cellWidth, int cellHeight, int cellDepth);
                    ...
                    */
                    ...
                    std::vector<EntityId> getEntities(std::string type);
                    std::vector<EntityId> getRootEntities(std::string type);
                    std::vector<EntityId> getChildrenEntities(std::string type);
                    /**
                    ...
                    */
                    std::vector<EntityId> getVisibleEntities (std::string type);
                    /**
                    ...
                    * \return the entities.
                    */
                    std::vector<EntityId> getEntitiesInBox (physic::BoundingBox bx, std::string types);
                    /**
                    ...
                    */
                    ...
                    void generate_labyrinthe(std::vector<EntityId> tGround, std::vector<EntityId> walls, math::Vec2f tileSize, physic::BoundingBox &box);
                    ...
                    */
                    void generate_map(std::vector<EntityId> tGround, std::vector<EntityId> walls, math::Vec2f tileSize, physic::BoundingBox &box);
                    /**
                    ...
                    */
                    void getChildren (EntityId entity, std::vector<EntityId> &entities, std::string type);
