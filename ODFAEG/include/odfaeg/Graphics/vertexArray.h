    ...
    namespace graphic {
        ...
        class ODFAEG_GRAPHICS_API VertexArray : public Drawable
        {
           public :
            ...
            ///
            ////////////////////////////////////////////////////////////
            explicit VertexArray(sf::PrimitiveType type, unsigned int vertexCount = 0, Entity* entity = nullptr, entt::entity entityId = entt::null);
            Entity* getEntity();
            ...
            void addNormal(sf::Vector3f normal);
