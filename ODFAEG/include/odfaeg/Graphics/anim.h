        ...
        class ODFAEG_GRAPHICS_API Anim : public AnimatedEntity {
            ...
            private :
                ...
                */
                ...
                core::Clock clock; /**> the clock to measure times before frames.*/
                ...
                Entity* rpInterpolatedFrame;
                std::string auname;
                bool ownCurrentFrame;
        };
    }
}
#endif
