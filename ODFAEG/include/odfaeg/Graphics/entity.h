        ...
        class ODFAEG_GRAPHICS_API Entity : public Transformable, public Drawable, public core::Registered<Entity> {
            ...
            public :
                ...
                */
                ...
                virtual bool getHeight(math::Vec2f point, float& height);
                ...
                virtual core::Time getElapsedTime();
                ...
                virtual void stop();
                virtual void update(core::Time dt);
                virtual void update();
                ...
                int getBorderId();
                virtual TransformMatrix& getChildTransform();
                #ifdef VULKAN
