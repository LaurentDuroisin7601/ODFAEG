...
namespace odfaeg {
    namespace network {
        ...
        ////////////////////////////////////////////////////////////
        Socket::Status TcpSocket::connect(const IpAddress& remoteAddress, unsigned short remotePort, core::Time timeout)
        {
