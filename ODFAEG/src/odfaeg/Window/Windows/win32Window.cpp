...
#include "../../../../include/odfaeg/Window/windowStyle.hpp"
#include <GL/gl.h>
#include "../../../../include/odfaeg/Core/utf.hpp"
...
namespace odfaeg {
    namespace window {
        ...
        ////////////////////////////////////////////////////////////
        Win32Window::Win32Window(VideoMode mode, const core::String& title, std::uint32_t style, const ContextSettings& settings) :
        m_handle          (NULL),
        m_callback        (0),
        m_cursorVisible   (true), // might need to call GetCursorInfo
        m_lastCursor      (LoadCursor(NULL, IDC_ARROW)),
        ...
        math::Vector2u Win32Window::getSize() const
        {
            ...
            return math::Vector2u(rect.right - rect.left, rect.bottom - rect.top);
        }
