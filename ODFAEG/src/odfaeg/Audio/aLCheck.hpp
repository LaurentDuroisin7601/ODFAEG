...
#ifndef ODFAEG_ALCHECK_HPP
#define ODFAEG_ALCHECK_HPP
...
namespace odfaeg
{
    namespace audio {
        ...
        ////////////////////////////////////////////////////////////
            ...
            #define alCheck(expr) do { expr; odfaeg::audio::priv::alCheckError(__FILE__, __LINE__, #expr); } while (false)
