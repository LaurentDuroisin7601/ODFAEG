...
namespace odfaeg
{
    namespace audio {
        ...
        ////////////////////////////////////////////////////////////
        core::Time InputSoundFile::getDuration() const
        {
            // Make sure we don't divide by 0
            if (m_channelCount == 0 || m_sampleRate == 0)
                return core::Time::zero;

            return core::seconds(static_cast<float>(m_sampleCount) / m_channelCount / m_sampleRate);
        }


        ////////////////////////////////////////////////////////////
        core::Time InputSoundFile::getTimeOffset() const
        {
            // Make sure we don't divide by 0
            if (m_channelCount == 0 || m_sampleRate == 0)
                return core::Time::zero;

            return core::seconds(static_cast<float>(m_sampleOffset) / m_channelCount / m_sampleRate);
        }
        ...
        ////////////////////////////////////////////////////////////
        void InputSoundFile::seek(core::Time timeOffset)
        {
            seek(static_cast<std::uint64_t>(timeOffset.asSeconds() * m_sampleRate * m_channelCount));
        }
