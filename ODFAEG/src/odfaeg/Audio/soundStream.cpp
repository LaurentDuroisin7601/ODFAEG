...
// Headers
////////////////////////////////////////////////////////////
#include "../../../include/odfaeg/Audio/soundStream.hpp"
...
namespace odfaeg {
    ...
    namespace audio {
        ...
        ////////////////////////////////////////////////////////////
        void SoundStream::setPlayingOffset(core::Time timeOffset)
        {
        ...
        ////////////////////////////////////////////////////////////
        core::Time SoundStream::getPlayingOffset() const
        {
            if (m_sampleRate && m_channelCount)
            {
                ...
                return core::seconds(secs + static_cast<float>(m_samplesProcessed) / m_sampleRate / m_channelCount);
            }
            else
            {
