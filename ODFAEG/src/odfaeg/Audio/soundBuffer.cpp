...
// Headers
////////////////////////////////////////////////////////////
#include "../../../include/odfaeg/Audio/soundBuffer.hpp"
#include "../../../include/odfaeg/Audio/inputSoundFile.hpp"
#include "../../../include/odfaeg/Audio/sound.hpp"
...
namespace odfaeg {
    ...
    namespace audio {
        ...
        ////////////////////////////////////////////////////////////
        bool SoundBuffer::loadFromSamples(const std::int16_t* samples, std::uint64_t sampleCount, unsigned int channelCount, unsigned int sampleRate)
        {
        ...
        ////////////////////////////////////////////////////////////
        core::Time SoundBuffer::getDuration() const
        {
            return m_duration;
        }
        ...
        bool SoundBuffer::update(unsigned int channelCount, unsigned int sampleRate)
        {
            ...
            m_duration = core::seconds(static_cast<float>(m_samples.size()) / sampleRate / channelCount);
