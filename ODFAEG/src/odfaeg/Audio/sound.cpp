...
// Headers
////////////////////////////////////////////////////////////
#include <ODFAEG/Audio/Sound.hpp>
#include <ODFAEG/Audio/SoundBuffer.hpp>
#include <ODFAEG/Audio/ALCheck.hpp>
...
namespace odfaeg {
    ...
    namespace audio {
        ...
        ////////////////////////////////////////////////////////////
        void Sound::setPlayingOffset(core::Time timeOffset)
        {
        ...
        ////////////////////////////////////////////////////////////
        core::Time Sound::getPlayingOffset() const
        {
            ALfloat secs = 0.f;
            alCheck(alGetSourcef(m_source, AL_SEC_OFFSET, &secs));

            return core::seconds(secs);
        }
