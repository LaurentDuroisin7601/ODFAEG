...
namespace
{
    ...
    odfaeg::math::Vec3f listenerPosition (0.f, 0.f, 0.f);
    odfaeg::math::Vec3f listenerDirection(0.f, 0.f, -1.f);
    odfaeg::math::Vec3f listenerUpVector (0.f, 1.f, 0.f);
}
...
namespace odfaeg {
    ...
    namespace audio {
        ...
        ////////////////////////////////////////////////////////////
        void AudioDevice::setPosition(const math::Vec3f& position)
        {
            if (audioContext)
        ...
        ////////////////////////////////////////////////////////////
        math::Vec3f AudioDevice::getPosition()
        {
        ...
        ////////////////////////////////////////////////////////////
        void AudioDevice::setDirection(const math::Vec3f& direction)
        {
            if (audioContext)
            {
        ...
        ////////////////////////////////////////////////////////////
        math::Vec3f AudioDevice::getDirection()
        {
        ...
        ////////////////////////////////////////////////////////////
        void AudioDevice::setUpVector(const math::Vec3f& upVector)
        {
            if (audioContext)
            {
        ...
        ////////////////////////////////////////////////////////////
        math::Vec3f AudioDevice::getUpVector()
        {
