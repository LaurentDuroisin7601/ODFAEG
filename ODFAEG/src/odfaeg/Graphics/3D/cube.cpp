    ...
    namespace graphic {
        namespace g3d {
            ...
            Cube::Cube (math::Vec3f position, float w, float h, float d, Color color, EntityFactory& factory) : GameObject(position,math::Vec3f(w, h, d),math::Vec3f(w*0.5f,h*0.5f,d*0.5f),"E_CUBE", factory) {
                ...
                Vertex v1(Vector3f(w, 0, 0), color);
                Vertex v2(Vector3f(w, h, 0), color);
                Vertex v3(Vector3f(w, h, d), color);
                Vertex v4(Vector3f(w, 0, d), color);
                va1[0] = v1;
                va1[1] = v2;
                va1[2] = v3;
                va1[3] = v4;
                ...
                Vertex v5(Vector3f(0, 0, 0), color);
                Vertex v6(Vector3f(0, h, 0), color);
                Vertex v7(Vector3f(0, h, d), color);
                Vertex v8(Vector3f(0, 0, d), color);
                va2[0] = v5;
                va2[1] = v6;
                va2[2] = v7;
                va2[3] = v8;
                ...
                Vertex v9(Vector3f(0, h, 0), color);
                Vertex v10(Vector3f(w, h, 0), color);
                Vertex v11(Vector3f(w, h, d), color);
                Vertex v12(Vector3f(0, h, 0), color);
                va3[0] = v9;
                va3[1] = v10;
                va3[2] = v11;
                va3[3] = v12;
                ...
                Vertex v13(Vector3f(0, 0, 0), color);
                Vertex v14(Vector3f(w, 0, 0), color);
                Vertex v15(Vector3f(w, 0, d), color);
                Vertex v16(Vector3f(0, 0, d), color);
                va4[0] = v13;
                va4[1] = v14;
                va4[2] = v15;
                va4[3] = v16;
                ...
                Vertex v17(Vector3f(0, 0, d), color);
                Vertex v18(Vector3f(w, 0, d), color);
                Vertex v19(Vector3f(w, h, d), color);
                Vertex v20(Vector3f(0, h, d), color);
                va5[0] = v17;
                va5[1] = v18;
                va5[2] = v19;
                va5[3] = v20;
                ...
                Vertex v21(Vector3f(0, 0, 0), color);
                Vertex v22(Vector3f(w, 0, 0), color);
                Vertex v23(Vector3f(w, h, 0), color);
                Vertex v24(Vector3f(0, h, 0), color);
                va6[0] = v21;
                va6[1] = v22;
                va6[2] = v23;
                va6[3] = v24;
