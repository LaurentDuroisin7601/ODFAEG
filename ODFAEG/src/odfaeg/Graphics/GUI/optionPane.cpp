...
namespace odfaeg {
    namespace graphic {
        namespace gui {
            #ifdef VULKAN
            OptionPane::OptionPane(window::Device& vkDevice, math::Vec3f position, math::Vec3f size, const Font* font, core::String t, TYPE type) :
                rw (window::VideoMode(size.x(), size.y()), "Option Pane", vkDevice, window::Style::Default, window::ContextSettings(3, 0, 0, 0, 0)),
