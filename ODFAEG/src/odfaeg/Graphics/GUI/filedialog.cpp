...
namespace odfaeg {
    namespace graphic {
        namespace gui {
            #ifdef VULKAN
            FileDialog::FileDialog(window::Device& vkDevice, math::Vec3f position, math::Vec3f size, const Font* font) :
            rw(window::VideoMode(size.x(), size.y()), "File Dialog", vkDevice, window::Style::Default, window::ContextSettings(0, 0, 0, 3, 0)),
            ...
            font(font) {
                ...
                lTop->setForegroundColor(Color::Black);
                pTop->addChild(lTop);
                lTop->setText(currentPath);
                lTop->setBackgroundColor(Color::Red);
                ...
                if (DIR* root = opendir("/")) {
                    ...
                    while((ent = readdir(root)) != NULL) {
                        if (strcmp(ent->d_name, ".") && strcmp(ent->d_name, "..")) {
                            ...
                            //lDirectory->setBackgroundColor(Color(math::Math::random(0, 255),math::Math::random(0, 255), math::Math::random(0, 255), 255));
                            ...
                            lDirectory->setText(core::String(textDir));
                            ...
                            if(ent->d_type == DT_DIR) {
                                lDirectory->setForegroundColor(Color::Red);
                ...
                if (DIR* current = opendir(currentPath.c_str())) {
                    ...
                    while ((ent = readdir(current)) != NULL) {
                        if (strcmp(ent->d_name, ".") && strcmp(ent->d_name, "..")) {
                            ...
                            //lFile->setBackgroundColor(Color(math::Math::random(0, 255),math::Math::random(0, 255), math::Math::random(0, 255), 255));
                            lFile->setParent(pFiles);
                            lFile->setRelPosition(0.f, 0.04f * i);
                            lFile->setRelSize(1.f, 0.04f);
                            pFiles->addChild(lFile);
                            lFile->setText(core::String(fileNames));
                            core::Action a (core::Action::EVENT_TYPE::MOUSE_BUTTON_PRESSED_ONCE, window::IMouse::Left);
                            ...
                            if(ent->d_type == DT_DIR) {
                                lFile->setForegroundColor(Color::Red);
                    ...
                    while((ent = readdir(root)) != NULL) {
                        if (strcmp(ent->d_name, ".") && strcmp(ent->d_name, "..")) {
                            ...
                            if(S_ISDIR(st.st_mode)) {
                                ...
                                lDirectory->setForegroundColor(Color::Black);
                                getListener().connect("1f"+textDir, cmd);
                            }
                            i++;
                        }
                    ...
                    while ((ent = readdir(current)) != NULL) {
                        if (strcmp(ent->d_name, ".") && strcmp(ent->d_name, "..")) {
                            ...
                            if(S_ISDIR(st.st_mode)) {
                                ...
                                lFile->setForegroundColor(Color::Black);
                                getListener().connect("2f"+fileNames, cmd);
                            }
                            i++;
                        }
            ...
            void FileDialog::onDirSelected(Label* label) {
                for (unsigned int i = 0; i < pFiles->getChildren().size(); i++) {
                    if (static_cast<Label*>(pFiles->getChildren()[i])->getForegroundColor() == Color::Red) {
                ...
                for (unsigned int i = 0; i < pDirectories->getChildren().size(); i++) {
                    static_cast<Label*>(pDirectories->getChildren()[i])->setBackgroundColor(Color::Black);
                }
                std::string dirName;
                #if defined (ODFAEG_SYSTEM_LINUX)
                ...
                if (label->getForegroundColor() == Color::Red) {
                    #if defined (ODFAEG_SYSTEM_LINUX)
            ...
            void FileDialog::onFileSelected(Label* label) {
                ...
                Color color = label->getForegroundColor();
                if (color == Color::Red) {
                    for (unsigned int i = 0; i < pFiles->getChildren().size(); i++) {
                        if (static_cast<Label*>(pFiles->getChildren()[i])->getForegroundColor() == Color::Red) {
                    ...
                    for (unsigned int i = 0; i < pFiles->getChildren().size(); i++) {
                        static_cast<Label*>(pFiles->getChildren()[i])->setBackgroundColor(Color::Black);
                    }
                    label->setBackgroundColor(Color::Blue);
                }
                setAutoResized(true);
            ...
            void FileDialog::actionPerformed(Button* button) {
                if (button->getText() == "Choose") {
                    ...
                    for (unsigned int i = 0; i < pDirectories->getChildren().size(); i++) {
                        ...
                        if (label->getForegroundColor() == Color::Black
                            && label->getBackgroundColor() == Color::Blue) {
