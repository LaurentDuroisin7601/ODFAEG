...
namespace odfaeg {
    namespace graphic {
        namespace ecs {
                                                              ...
                                                              return position;
                                                                     ...
                                                                     void main () {
                                                                         ...
                                                                         if (layer > depth.y || layer == depth.y && z >= depth.z) {
                                                                             ...
                                                                             //print(ivec2(200, 100), 1, vec4(1, 0, 0, 1), lightPos);
                                                                             /*for (int i = 0; i < 800; i++) {
                                                                                for (int j = 0; j < 600; j++) {
                                                                                    imageStore(img_output, ivec2(i, j), vec4(1, 0, 0, 1));
                                                                                }
                                                                             }*/
                                                                             //imageStore(img_output, ivec2(gl_FragCoord.xy), vec4(1, 0, 0, 1));
            ...
            void LightRenderComponent::drawLightNormals() {
                for (unsigned int i = 0; i < Batcher::nbPrimitiveTypes; i++) {
                ...
                for (unsigned int i = 0; i < m_light_instances.size(); i++) {
                    if (m_light_instances[i].getAllVertices().getVertexCount() > 0) {
                        ...
                        for (unsigned int j = 0; j < m_light_instances[i].getAllVertices().getVertexCount(); j++) {
                            ...
                            vbBindlessTex[p].addLayer(m_light_instances[i].getMaterial().getLayer());
                            vbBindlessTex[p].addLightInfos(m_light_instances[i].getMaterial().getLightCenter(), m_light_instances[i].getMaterial().getLightColor());
                        }
                    }
                }
                RenderStates states;
                ...
                for (unsigned int p = 0; p < Batcher::nbPrimitiveTypes; p++) {
                    if (vbBindlessTex[p].getVertexCount() > 0) {
                        ...
                        lightMap.drawVertexBuffer(vbBindlessTex[p], states);
                    }
                }
                    ...
                    if (m_instances[i].getAllVertices().getVertexCount() > 0) {
                        ...
                        for (unsigned int p = 0; p < Batcher::nbPrimitiveTypes; p++) {
                            if (vbBindlessTex[p].getVertexCount() > 0) {
                                ...
                                vbBindlessTex[p].update();
                                depthBuffer.drawIndirect(vbBindlessTex[p], vbBindlessTex[p].getPrimitiveType(), drawArraysIndirectCommands[p].size(), states, vboIndirect, vboWorldMatrices);
                            }
                        }
                        ...
                        for (unsigned int p = 0; p < Batcher::nbPrimitiveTypes; p++) {
                            if (vbBindlessTex[p].getVertexCount() > 0) {
                                vbBindlessTex[p].update();
                                alphaBuffer.drawIndirect(vbBindlessTex[p], vbBindlessTex[p].getPrimitiveType(), drawArraysIndirectCommands[p].size(), states, vboIndirect, vboWorldMatrices);
                                vbBindlessTex[p].clear();
                            }
                        }
                        glCheck(glMemoryBarrier(GL_SHADER_IMAGE_ACCESS_BARRIER_BIT));
                    ...
                    if (m_instances[i].getAllVertices().getVertexCount() > 0) {
                        ...
                        for (unsigned int p = 0; p < Batcher::nbPrimitiveTypes; p++) {
                            if (vbBindlessTex[p].getVertexCount() > 0) {
                                ...
                                glCheck(glBindBuffer(GL_DRAW_INDIRECT_BUFFER, 0));
                                vbBindlessTex[p].update();
                                bumpTexture.drawIndirect(vbBindlessTex[p], vbBindlessTex[p].getPrimitiveType(), drawArraysIndirectCommands[p].size(), states, vboIndirect, vboWorldMatrices);
                                vbBindlessTex[p].clear();
                            }
                        }
                    }
                    ...
                    if (m_instances[i].getAllVertices().getVertexCount() > 0) {
                        ...
                        for (unsigned int p = 0; p < Batcher::nbPrimitiveTypes; p++) {
                            if (vbBindlessTex[p].getVertexCount() > 0) {
                                ...
                                glCheck(glBindBuffer(GL_DRAW_INDIRECT_BUFFER, 0));
                                vbBindlessTex[p].update();
                                specularTexture.drawIndirect(vbBindlessTex[p], vbBindlessTex[p].getPrimitiveType(), drawArraysIndirectCommands[p].size(), states, vboIndirect, vboWorldMatrices);
                                vbBindlessTex[p].clear();
                            }
                        }
                    }
