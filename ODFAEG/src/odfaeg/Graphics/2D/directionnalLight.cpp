        ...
        namespace g2d {
            ...
            void DirectionnalLight::initTriangles () {
                ...
                for (int i = 0; i < end; i++) {
                    ...
                    v1 = math::Vec3f (center.x(), center.y(), center.z());
                    v2 = math::Vec3f (center.x() + getSize().x() * 0.5f * math::Math::cosinus (i * angle), center.y() + getSize().y() * 0.5f * math::Math::sinus (i * angle), 0);
                    v3 = math::Vec3f (center.x() + getSize().x() * 0.5f * math::Math::cosinus ((i + 1) * angle), center.y() + getSize().y() * 0.5f * math::Math::sinus ((i + 1) * angle), 0);
            ...
            /*void DirectionnalLight::intersectsWallCompletely(Vec2f &pointI1, Vec2f &pointI2, int i1, int i2, int numTris) {
                ...
                */
                ...
                if (i1 == 0 && i2 == 2) {
                    ...
                    (*triangles[numTris])[1].position = math::Vec3f(pointI1.x, pointI1.y, 0);
                    int alpha = compAlphaFromPoint(pointI1);
                    color2.a = alpha;
                    (*triangles[numTris])[1].color = color2;

                    (*triangles[numTris])[2].position = math::Vec3f(pointI2.x, pointI2.y, 0);
                ...
                */
                /*} else if (i1 == 0 && i2 == 1) {
                    ...
                    math::Vec3f a ((*triangles[numTris])[0].position.x, (*triangles[numTris])[0].position.y, 0);
                    math::Vec3f b (pointI1.x, pointI1.y, 0);
                    math::Vec3f c (pointI2.x, pointI2.y, 0);
                    VertexArray *triangle = new VertexArray (Triangles);
                    ...
                    addTriangle(triangle);
                    (*triangles[numTris])[1].position = math::Vec3f(pointI2.x, pointI2.y, 0);
                    (*triangles[numTris])[1].color = color2;
                ...
                /*} else if (i1 == 1 && i2 == 2) {
                    math::Vec3f a = math::Vec3f((*triangles[numTris])[0].position.x, (*triangles[numTris])[0].position.y, 0);
                    math::Vec3f b (pointI1.x, pointI1.y, 0);
                    math::Vec3f c (pointI2.x, pointI2.y, 0);
                    VertexArray *triangle = new VertexArray (Triangles);
                    triangle->append(Vertex(a, color));
                    ...
                    triangle->append(Vertex(c, color2));
                    addTriangle(triangle);
                    (*triangles[numTris])[2].position = math::Vec3f(pointI1.x, pointI1.y, 0);
                    color2.a = alpha1;
                    (*triangles[numTris])[2].color = color2;
                }
            }
            ...
            */
                ...
                if (!result.isNulVector()) {
                    ...
                    if (i != 1) {
                        ...
                        if (i == 0) {
                            ...
                            color2.a = alphaPI2;
                            quad->append(Vertex(math::Vec3f(pointI2.x, pointI2.y, 0), color2));
                            color2.a = alphaP1;
                            quad->append(Vertex((*triangles[n])[1].position, color2));
                            color2.a = alphaP2;
                            quad->append(Vertex((*triangles[n])[2].position, color2));
                            color2.a = alphaPI1;
                            (*triangles[n])[1].position = math::Vec3f(pointI1.x,pointI1.y, 0);
                            (*triangles[n])[1].color = color2;
                            color2.a = alphaPI2;
                            (*triangles[n])[2].position = math::Vec3f(pointI2.x,pointI2.y, 0);
                            (*triangles[n])[1].color = color2;
                            addTriangle(quad);
                        } else {
                            int alphaP1 = (*triangles[n])[1].color.a;
                            ...
                            quad->append(Vertex(math::Vec3f(pointI2.x, pointI2.y, 0), color2));
                            color2.a = alphaPI2;
                            (*triangles[n])[1].position = math::Vec3f(pointI2.x,pointI2.y, 0);
                            (*triangles[n])[1].color = color2;
                            color2.a = alphaPI1;
                            (*triangles[n])[2].position = math::Vec3f(pointI1.x,pointI1.y, 0);
                            (*triangles[n])[1].color = color2;
                            addTriangle(quad);
                        }
                    } else {
                     ...
                     /*   float dist1 = Vec2f((*triangles[n])[1].position.x,(*triangles[n])[1].position.y).computeDist(pointI2);
                        ...
                        if (dist1 < dist2) {
                            ...
                            int alphaPI2 = compAlphaFromPoint(pointI2);
                            VertexArray *quad = new VertexArray(Quads);
                            quad->append(Vertex(math::Vec3f(a.x, a.y, 0), color));
                            color2.a = alphaP1,
                            quad->append(Vertex((*triangles[n])[1].position, color2));
                            color2.a = alphaPI1;
                            quad->append(Vertex(math::Vec3f(pointI1.x, pointI1.y, 0), color2));
                            color2.a = alphaPI2;
                            quad->append(Vertex(math::Vec3f(pointI2.x, pointI2.y, 0), color2));
                            (*triangles[n])[1].position = math::Vec3f(pointI2.x, pointI2.y, 0);
                            (*triangles[n])[1].color = color2;
            ...
            void DirectionnalLight::computeCone () {
                ...
                Color color2 (color.r, color.g, color.b, 0);
                s1->append(Vertex(math::Vec3f(centerCone.x(), centerCone.y(), 0), color1));
                s1->append(Vertex(math::Vec3f(origCone.x(), origCone.y(), 0), color2));
                s1->append(Vertex(math::Vec3f(extCenter1.x(), extCenter1.y(), 0), color2));
                //s1->SetBlendMode(Blend::Add);
                coneTris.push_back(s1);
                VertexArray* s2 = new VertexArray (Triangles);
                s2->append(Vertex(math::Vec3f(centerCone.x(), centerCone.y(), 0), color1));
                s2->append(Vertex(math::Vec3f(origCone.x(), origCone.y(), 0), color2));
                s2->append(Vertex(math::Vec3f(extCenter2.x(), extCenter2.y(), 0), color2));
                //s2->SetBlendMode(Blend::Add);
                coneTris.push_back(s2);
                VertexArray* s3 = new VertexArray (Quads);
                s3->append(Vertex(math::Vec3f(centerCone.x(), centerCone.y(), 0), color1));
                s3->append(Vertex(math::Vec3f(extCenter1.x(), extCenter1.y(), 0), color2));
                s3->append(Vertex(math::Vec3f(ext1.x(), ext1.y(), 0), color2));
                s3->append(Vertex(math::Vec3f(center.x(), center.y(), 0), color1));
                //s3->SetBlendMode(Blend::Add);
                coneTris.push_back(s3);
                VertexArray* s4 = new VertexArray (Quads);
                s4->append(Vertex(math::Vec3f(centerCone.x(), centerCone.y(), 0), color1));
                s4->append(Vertex(math::Vec3f(extCenter2.x(), extCenter2.y(), 0), color2));
                s4->append(Vertex(math::Vec3f(ext2.x(), ext2.y(), 0), color2));
                s4->append(Vertex(math::Vec3f(center.x(), center.y(), 0), color1));
