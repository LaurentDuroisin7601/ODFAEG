...
#if !defined(ODFAEG_DEBUG)
    loadLibrary("odfaeg-core", lJNIEnv, ObjectActivityInfo);
    loadLibrary("odfaeg-maths", lJNIEnv, ObjectActivityInfo);
    loadLibrary("odfaeg-physics", lJNIEnv, ObjectActivityInfo);
    loadLibrary("odfaeg-window", lJNIEnv, ObjectActivityInfo);
    loadLibrary("odfaeg-graphics", lJNIEnv, ObjectActivityInfo);
    loadLibrary("odfaeg-audio", lJNIEnv, ObjectActivityInfo);
    loadLibrary("odfaeg-network", lJNIEnv, ObjectActivityInfo);
#else
    loadLibrary("odfaeg-core-d", lJNIEnv, ObjectActivityInfo);
    loadLibrary("odfaeg-physics-d", lJNIEnv, ObjectActivityInfo);
    loadLibrary("odfaeg-maths-d", lJNIEnv, ObjectActivityInfo);
    loadLibrary("odfaeg-graphics-d", lJNIEnv, ObjectActivityInfo);
    loadLibrary("odfaeg-audio-d", lJNIEnv, ObjectActivityInfo);
    loadLibrary("odfaeg-network-d", lJNIEnv, ObjectActivityInfo);
#endif
